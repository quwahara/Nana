...
//    {
//        public TypAnalyzer Above { [DebuggerNonUserCode] get { return Above_ as TypAnalyzer; } }
//        public Typ BaseTyp;
//        public Token Seed;
...
namespace Nana.Semantics
{
    ...
    {
        //  structures
        public SemanticAnalyzer2 Above;
        public LinkedList<SemanticAnalyzer2> Subs = new LinkedList<SemanticAnalyzer2>();

        //  data
        public Token Seed;

        public SemanticAnalyzer2(Token seed, SemanticAnalyzer2 above) { Seed = seed; Above = above; }

        public virtual void ConstructSubs() { }

        public void ConstructSubsAll()
        {
            foreach (SemanticAnalyzer2 s in Subs)
            { s.ConstructSubs(); }
        }
        ...
        public LinkedList<T> CollectTypeIs<T>() where T : class
        {
            ...
            foreach (SemanticAnalyzer2 sub in Subs)
            {
        ...
        public LinkedList<T> CollectTypeOf<T>() where T : SemanticAnalyzer2
        {
            LinkedList<T> ls = new LinkedList<T>();
            foreach (SemanticAnalyzer2 sub in Subs)
            {
        ...
        public T FindUpTypeOf<T>() where T : SemanticAnalyzer2
        {
    ...
    public class LineAnalyzer2 : SemanticAnalyzer2
    {
        public BlockAnalyzer2 AboveBlock;
        ...
        public LineAnalyzer2(Token seed, BlockAnalyzer2 above)
            : base(seed, above)
        {
            Breaks = new Stack<Literal>();
            Continues = new Stack<Literal>();
        ...
        {
            Actn = FindUpTypeIs<ActnAnalyzer2>().Actn;
            IsInFctn = Actn is Fctn;
            Fctn = IsInFctn ? Actn as Fctn : null;
            Env = Actn.Env;
            TmpVarGen = new TmpVarGenerator(Env.GetTempName, Actn.NewVar);
    ...
    public class BlockAnalyzer2 : SemanticAnalyzer2
    {
        public BlockAnalyzer2 AboveBlock;
        ...
        public BlockAnalyzer2(Token seed, BlockAnalyzer2 above)
            : base(seed, above)
        {
            AboveBlock = above;
        }
        ...
        public override void ConstructSubs()
        {
            ...
            { Subs.AddLast(new LineAnalyzer2(f, this)); }
            ConstructSubsAll();
        }

        public void AnalyzeBlock()
        {
            Nsp = FindUpTypeIs<ActnAnalyzer2>().Actn;
            foreach (SemanticAnalyzer2 a in Subs)
            {
                if (a.GetType() != typeof(LineAnalyzer2))
                { continue; }
                (a as LineAnalyzer2).AnalyzeLine(); 
            }
        }
    ...
    public class ActnAnalyzer2 : BlockAnalyzer2
    {
        public Actn Actn_;
        public Actn Actn
        {
        ...
        public ActnAnalyzer2(Token seed, BlockAnalyzer2 above)
            : base(seed, above)
        { }
        ...
        public override void ConstructSubs()
        {
            ...
            Subs.AddLast(new BlockAnalyzer2(block, this));
            ConstructSubsAll();
        }
        ...
        public void AnalyzeActn()
        {
            ...
            TypAnalyzer2 typazr2 = FindUpTypeOf<TypAnalyzer2>()
                ?? FindUpTypeOf<AppAnalyzer2>()
                ;
            Debug.Assert(typazr2 != null);
            ActnOvld ovld = typazr2.Typu.FindOrNewActnOvld(nameasm);
            ...
            Typ voidtyp =  FindUpTypeOf<EnvAnalyzer2>().Env.FindOrNewRefType(typeof(void));

            Typ returnType = voidtyp;
            if (isCtor)
            {
                returnType = FindUpTypeIs<TypAnalyzer2>().Typu;
            ...
            if (Actn.IsInstance)
            {
                TypAnalyzer2 typazr = FindUpTypeOf<TypAnalyzer2>();
                if (typazr == null)
                { throw new SyntaxError("Cannot define instance constructor in this sapce", t); }
                Actn.NewThis();
            }
    ...
    public class TypAnalyzer2 : ActnAnalyzer2
    {
        public Typ Typu_;
        public Typ Typu
        {
        ...
        public TypAnalyzer2(Token seed, BlockAnalyzer2 above)
            : base(seed, above)
        { }
        ...
        public override void ConstructSubs()
        {
            ...
            { Subs.AddLast(new ActnAnalyzer2(t, this)); }
            ConstructSubsAll();
        }
        ...
        public void AnalyzeTyp()
        {
            ...
            AppAnalyzer2 appazr = FindUpTypeOf<AppAnalyzer2>();
            App app = appazr.App;
            Typu = app.NewTyp(name);
    ...
    public class SrcAnalyzer2 : TypAnalyzer2
    {
        public List<string> Usings;

        public SrcAnalyzer2(Token seed, BlockAnalyzer2 above)
            : base(seed, above)
        {
            Usings = new List<string>();
        }
        ...
        public override void ConstructSubs()
        {
            ...
            foreach (Token t in Seed.Follows)
            {
                switch (t.Group)
                {
                    case "TypeDef": a = new TypAnalyzer2(t, this); break;
                    case "Func": a = new ActnAnalyzer2(t, this); break;
                    default: a = new LineAnalyzer2(t, this); break;
                }
                Subs.AddLast(a);
            }
            ConstructSubsAll();
        ...
        {
            base.Typu = FindUpTypeOf<AppAnalyzer2>().Typu;
        }
        ...
        public override Typ RequireTyp(Token t)
        {
            ...
            Token array = last;
            Env env = FindUpTypeOf<EnvAnalyzer2>().Env;
            while (array != null && SpecifiedTypAnalyzer.IsArray(array.Follows))
            {
                int dim = SpecifiedTypAnalyzer.GetDimension(array.Follows);
                typ = env.NewArrayTyp(typ, dim);
    ...
    public class AppAnalyzer2 : SrcAnalyzer2
    {
        public App App_;
        public App App
        {
        ...
        public AppAnalyzer2(Token seed, BlockAnalyzer2 above)
            : base(seed, above)
        { }
        ...
        public override void ConstructSubs()
        {
            ...
            { Subs.AddLast(new SrcAnalyzer2(t, this)); }
            ConstructSubsAll();
        }

        public void AnalyzeApp()
        {
            App = FindUpTypeOf<EnvAnalyzer2>().Env.NewApp(Seed);
        }
    ...
    public class EnvAnalyzer2 : AppAnalyzer2
    {
        public Env Env;

        public EnvAnalyzer2(Token seed)
            : base(seed, null)
        { }

        public static Env Run(Token root)
        {
            EnvAnalyzer2 ea = new EnvAnalyzer2(root);
            ea.Prelude();
            ea.Main();
            ea.Finale();
            return ea.Env;
        ...
        public override void ConstructSubs()
        {
            Subs.AddLast(new AppAnalyzer2(Seed.Find("@Syntax"), this));
            ConstructSubsAll();
        }
        ...
        {
            CollectTypeOf<AppAnalyzer2>().First.Value.AnalyzeApp();
        }

        public void AnalyzeSrcAll()
        {
            foreach (SrcAnalyzer2 a in CollectTypeOf<SrcAnalyzer2>())
            { a.AnalyzeSrc(); }
        }

        public void AnalyzeTypAll()
        {
            foreach (TypAnalyzer2 a in CollectTypeOf<TypAnalyzer2>())
            { a.AnalyzeTyp(); }
        }
        ...
        {
            foreach (ActnAnalyzer2 a in CollectTypeOf<ActnAnalyzer2>())
            { a.AnalyzeActn(); }
        }

        public void EnsureTypAll()
        {
            foreach (TypAnalyzer2 ta in CollectTypeOf<TypAnalyzer2>())
            {
                Typ y = ta.Typu;
                ...
                Token t = GenFuncToken("cons", /* name */ null, /* returnType */ null);
                ActnAnalyzer2 aa = new ActnAnalyzer2(t, ta);
                ta.Subs.AddLast(aa);
                aa.AnalyzeActn();
            }
        }
        ...
        {
            foreach (ActnAnalyzer2 aa in CollectTypeOf<ActnAnalyzer2>())
            {
                Typ mytyp
                    = (aa.FindUpTypeOf<TypAnalyzer2>()
                    ?? aa.FindUpTypeOf<AppAnalyzer2>()
                    ).Typu
                    ;
                Actn actn = aa.Actn;
        ...
        public void AnalyzeBlockAll()
        {
            foreach (SrcAnalyzer2 a in CollectTypeOf<SrcAnalyzer2>())
            { a.AnalyzeBlock(); }
            foreach (BlockAnalyzer2 a in CollectTypeOf<BlockAnalyzer2>())
            { a.AnalyzeBlock(); }
        }
        ...
        public void EnsureAppExe()
        {
            AppAnalyzer2 aa = CollectTypeOf<AppAnalyzer2>().First.Value;
            App app = aa.App;
            if (app.Exes.Count == 0) { return; }

            Token t = GenFuncToken("scons", Actn.EntryPointNameImplicit, "void");
            (new ActnAnalyzer2(t, aa)).AnalyzeActn();
            Actn cctor = app.FindActnOvld(".cctor").GetActnOf(new Typ[] { }, app);
            cctor.Exes.AddRange(app.Exes);
            app.Exes.Clear();
        }
